	...
	BEGIN TRY      
		BEGIN TRANSACTION      
			...
			BEGIN  
				...
				WITH (ID VARCHAR(100), ItemID VARCHAR(100), [Owner] VARCHAR(50), AgioReason NVARCHAR(100), AgioPercent FLOAT, AgioTotal FLOAT, AgioCost FLOAT, ReasonID VARCHAR(40), ReasonName NVARCHAR(100), AgioType VARCHAR(50));      
			END
