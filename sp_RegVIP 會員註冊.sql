CREATE   PROCEDURE [dbo].[sp_RegVIP]   
...
BEGIN   
    ...
    BEGIN TRANSACTION  
        ...
        SELECT @memberLevel=vct.CardTypeName,@validDays=vct.ValidDays FROM VIP_CardType vct   
        ...
        DECLARE @expiredDate DATETIME = DATEADD(DAY,@validDays,@createDate);  
